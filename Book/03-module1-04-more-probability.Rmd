...
as $X$, $Y$, and $Z$. The corresponding outcomes are denoted by lowercase letters $x$, $y$,
$z$.
...
\begin{figure}[h]
\centering
\includegraphics[width=4in]{images/Larry.jpeg}
\caption{Probability Mass Function of Larry Bird Free Throws}\label{bird}
\end{figure}
